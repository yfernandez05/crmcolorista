<template>
    <main-content columnClass="col-12 col-xl-10">
        ...
        <template v-slot:card-body-main>
            <div class="form-row">
                <div class="form-group col-12 col-sm-6 col-md-4" :class="{'has-danger':errorExists('nombre')}">
                    ...
                    <input type="text" class="form-control" v-model="carrera.nombre" @keyup.enter ="doSaveData"/>
                ...
                <div class="form-group col-12 col-sm-6 col-md-4" :class="{'has-danger':errorExists('descripcion')}">
                    ...
                    <input type="text" class="form-control" v-model="carrera.descripcion" @keyup.enter ="doSaveData"/>
                ...
                <div class="form-group col-12 col-sm-6 col-md-4" :class="{'has-danger':errorExists('duracion_meses')}">
                    <label>Duración en Meses <small class="text-danger">(*)</small></label>
                    <input type="text" class="form-control" v-model="carrera.duracion_meses" @keyup.enter ="doSaveData"/>
        ...
        <template v-slot:card-body-actions>
            <router-link :to="{name: 'spa.carrera'}" class="btn waves-effect waves-light btn-info mr-2">
        ...
        methods: {
            doSaveData() {
                ...
                let rolData = {
                    ...
                    duracion_meses: this.carrera.duracion_meses,
                }
            ...
            validateFields() {
                ...
                if (!this.carrera.duracion_meses) {
